  ...
  return (
    <section className="relative min-h-[85vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img src={heroImage} alt="Vue aérienne de Lyon 5ème" className="w-full h-full object-cover" />
      ...
      <div className="container relative z-10 py-20">
        ...
        >
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-navy-foreground leading-tight mb-4">
            ...
            <span className="text-gradient">CPTS Lyon 5</span>
          </h1>
          ...
          <p className="text-base md:text-lg text-navy-foreground/70 mb-8 leading-relaxed max-w-xl">
            La CPTS Lyon 5 rassemble les professionnels de santé du territoire pour améliorer la coordination des soins, la prévention et l'accès à la santé.
          </p>
