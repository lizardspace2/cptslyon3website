...
import { ArrowRight, Clock, Plus, Loader2 } from "lucide-react";
...
const NewsSection = () => {
  ...
  // Use DB articles if available, otherwise use default ones for demo
  const displayArticles = (dbArticles && dbArticles.length > 0) 
    ? dbArticles.map(art => ({
        ...
        image: art.image_url || "/placeholder-news.jpg",
        date: new Date(art.published_at).toLocaleDateString("fr-FR", {
          day: "numeric",
          month: "long",
          year: "numeric"
        })
      ...
      <div className="container relative z-10">
        ...
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-navy/40 font-bold italic">Recherche des dernières actualités...</p>
          </div>
        ) : (
